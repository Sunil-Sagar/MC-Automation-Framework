...
4. NEVER make a decision on my behalf. Present every step first.
   Wait for my approval before doing anything.
5. NEVER hallucinate dependencies, libraries, or methods.
   If unsure whether something exists, go read the file first.
6. NEVER use placeholder code like "// TODO" or "// add logic here".
...
9. Think out loud. Tell me what you are about to do and why.
